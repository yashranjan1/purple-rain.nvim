...
function M.invert_color(color)
    local hsluv = require("purple-rain.hsluv")
    if color ~= "NONE" then
...
function M.autocmds(config)
    local group = vim.api.nvim_create_augroup("purple-rain", { clear = true })
...
function M.terminal(colors)
    ...
    vim.g.terminal_color_8 = colors.terminalBlackBright

    -- light
    vim.g.terminal_color_7 = colors.terminalWhite
    vim.g.terminal_color_15 = colors.terminalWhiteBright

    -- colors
    vim.g.terminal_color_1 = colors.terminalRed
    vim.g.terminal_color_9 = colors.terminalRedBright

    vim.g.terminal_color_2 = colors.terminalGreen
    vim.g.terminal_color_10 = colors.terminalGreenBright

    vim.g.terminal_color_3 = colors.terminalYellow
    vim.g.terminal_color_11 = colors.terminalYellowBright

    vim.g.terminal_color_4 = colors.terminalBlue
    vim.g.terminal_color_12 = colors.terminalBlueBright

    vim.g.terminal_color_5 = colors.terminalMagenta
    vim.g.terminal_color_13 = colors.terminalMagentaBright

    vim.g.terminal_color_6 = colors.terminalCyan
    vim.g.terminal_color_14 = colors.terminalCyanBright
end

...
function M.setup()
  M.docs()
  local tokyonight = require("purple-rain")
  ...
  for extra, info in pairs(M.extras) do
    package.loaded["purple-rain.extra." .. extra] = nil
    local plugin = require("purple-rain.extra." .. extra)
    for style, style_name in pairs(styles) do
      tokyonight.setup({ style = style })
      tokyonight.load({ style = style })
      vim.cmd.colorscheme("purple-rain-" .. style)
